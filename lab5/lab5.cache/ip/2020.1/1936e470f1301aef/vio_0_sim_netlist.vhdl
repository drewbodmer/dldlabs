...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_out_one_8 is
  signal \data_int[0]_i_1__8_n_0\ : STD_LOGIC;
  signal \^data_int_reg[0]_0\ : STD_LOGIC;
  attribute DONT_TOUCH : boolean;
  attribute DONT_TOUCH of \Probe_out_reg[0]\ : label is std.standard.true;
  attribute KEEP : string;
...
\data_int[0]_i_1__8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      ...
      I1 => wr_probe_out(0),
      I2 => \^data_int_reg[0]_0\,
      O => \data_int[0]_i_1__8_n_0\
    );
\data_int_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => \data_int_reg[0]_1\,
      CE => '1',
      D => \data_int[0]_i_1__8_n_0\,
      Q => \^data_int_reg[0]_0\,
      R => SR(0)
    );
end STRUCTURE;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_out_all is
  ...
  attribute SOFT_HLUTNM of \G_PROBE_OUT[6].wr_probe_out[6]_i_1\ : label is "soft_lutpair16";
begin
...
\G_PROBE_OUT[7].wr_probe_out_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => \out\,
      CE => '1',
      D => \G_PROBE_OUT[7].wr_probe_out_reg[7]_0\,
      Q => wr_probe_out(7),
      R => \G_PROBE_OUT[1].wr_probe_out[1]_i_1_n_0\
    );
\G_PROBE_OUT[8].PROBE_OUT0_INST\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_out_one_7
     port map (
      Q(0) => Q(0),
      SR(0) => SR(0),
      clk => clk,
...
\G_PROBE_OUT[8].wr_probe_out[8]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \^g_probe_out[0].wr_probe_out[0]_i_4_0\,
...
\G_PROBE_OUT[9].PROBE_OUT0_INST\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_out_one_8
     port map (
      Q(0) => Q(0),
      SR(0) => SR(0),
      clk => clk,
...
\Probe_out_reg_int[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \G_PROBE_OUT[9].PROBE_OUT0_INST_n_1\,
      I2 => addr_p1(3),
      I3 => D(0),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio is
  ...
  attribute LC_TOTAL_PROBE_OUT_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_vio : entity is 10;
  attribute dont_touch : string;
...
DECODER_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_decoder
     port map (
      ...
      D(2 downto 0) => xsdb_addr_2_0_p1(2 downto 0),
      ...
      s_dwe_o => bus_dwe,
      s_rst_o => bus_rst,
      \wr_en_reg[2]_0\ => PROBE_IN_INST_n_2,
      \wr_en_reg[2]_1\ => PROBE_OUT_ALL_INST_n_11,
...
PROBE_IN_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_in_one
     port map (
      ...
      D(0) => probe_in0(0),
      E(0) => DECODER_INST_n_8,
      \G_PROBE_OUT[7].wr_probe_out[7]_i_1_0\ => PROBE_IN_INST_n_0,
      Q(15 downto 0) => Bus_Data_out(15 downto 0),
      Read_int_i_3_0 => PROBE_IN_INST_n_2,
      Read_int_i_4_0 => PROBE_IN_INST_n_3,
      clk => clk,
      internal_cnt_rst => internal_cnt_rst,
      \out\ => bus_clk,
...
PROBE_OUT_ALL_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_out_all
     port map (
      ...
      \G_PROBE_OUT[7].wr_probe_out_reg[7]_0\ => PROBE_IN_INST_n_0,
      \G_PROBE_OUT[8].wr_probe_out_reg[8]_0\ => PROBE_IN_INST_n_3,
      \G_PROBE_OUT[8].wr_probe_out_reg[8]_1\ => PROBE_IN_INST_n_2,
      Probe_out_reg(0) => Probe_out_reg(0),
      Q(0) => p_2_in,
      SR(0) => clear,
      clk => clk,
